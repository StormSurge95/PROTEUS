...
struct NesEventSink {
    ...
    virtual void OnPpuRegisterRead(string details, u16 addr, u8 value) = 0;
    virtual void OnPpuRegisterWrite(string details, u16 addr, u8 value) = 0;
    virtual void OnApuRegisterRead(string details, u16 addr, u8 value) = 0;
    virtual void OnApuRegisterWrite(string details, u16 addr, u8 value) = 0;
